...
class S {
  ...
  String get deselect {
    return Intl.message(
      'Deselect',
      name: 'deselect',
      desc: 'Deselect a (selectable) item',
      args: [],
    );
  }
  ...
  String get notSelected {
    return Intl.message(
      'Not selected',
      name: 'notSelected',
      desc: 'Indicates the status of a (selectable) item not being selected',
      args: [],
    );
  }
  ...
  String get selected {
    return Intl.message(
      'Selected',
      name: 'selected',
      desc: 'Indicates status of a (selectable) item being selected',
      args: [],
    );
  }
  ...
  String get demoCupertinoPickerTitle {
    return Intl.message(
      ...
      desc: 'Title for the cupertino pickers component demo.',
      args: [],
    );
  }
  ...
  String get demoCupertinoPicker {
    return Intl.message(
      ...
      desc: 'Label to open an iOS picker.',
      args: [],
    );
  }
  ...
  String get demoCupertinoSearchTextFieldTitle {
    return Intl.message(
      ...
      desc: 'Title for the cupertino search text field demo.',
      args: [],
    );
  }
  ...
  String get demoCupertinoSearchTextFieldSubtitle {
    return Intl.message(
      ...
      desc: 'Subtitle for the cupertino search text field demo.',
      args: [],
    );
  }
  ...
  String get demoCupertinoSearchTextFieldDescription {
    return Intl.message(
      ...
      desc: 'Description for the cupertino search text field demo.',
      args: [],
    );
  }
  ...
  String get demoCupertinoSearchTextFieldPlaceholder {
    return Intl.message(
      ...
      desc: 'The placeholder for a search text field demo.',
      args: [],
    );
  }
  ...
  String get demoCupertinoScrollbarTitle {
    return Intl.message(
      ...
      desc: 'Title for the cupertino scrollbar demo.',
      args: [],
    );
  }
  ...
  String get demoCupertinoScrollbarSubtitle {
    return Intl.message(
      ...
      desc: 'Subtitle for the cupertino scrollbar demo.',
      args: [],
    );
  }
  ...
  String get demoCupertinoScrollbarDescription {
    return Intl.message(
      ...
      desc: 'Description for the cupertino scrollbar demo.',
      args: [],
    );
  }
  ...
  String get demoTextFieldLifeStory {
    return Intl.message(
      ...
      desc: 'The label for biography/life story input field.',
      args: [],
    );
  }
  ...
  String get demo {
    return Intl.message(
      'Demo',
      name: 'demo',
      desc: 'Used in the title of the demos.',
      args: [],
    );
  }
  ...
  String get bottomAppBar {
    return Intl.message(
      'Bottom app bar',
      name: 'bottomAppBar',
      desc: 'Used as semantic label for a BottomAppBar.',
      args: [],
    );
  }
  ...
  String get demoTwoPaneFoldableLabel {
    return Intl.message(
      ...
      desc: 'Option title for TwoPane demo on foldable devices.',
      args: [],
    );
  }
  ...
  String get demoTwoPaneTabletLabel {
    return Intl.message(
      ...
      desc: 'Option title for TwoPane demo in tablet or desktop mode.',
      args: [],
    );
  }
  ...
  String get demoTwoPaneTitle {
    return Intl.message(
      ...
      desc: 'Title for the TwoPane widget demo.',
      args: [],
    );
  }
  ...
  String get demoTwoPaneSubtitle {
    return Intl.message(
      ...
      desc: 'Subtitle for the TwoPane widget demo.',
      args: [],
    );
  }
  ...
  String demoTwoPaneItem(Object value) {
    return Intl.message(
      ...
      desc: 'Generic item placeholder visible in the TwoPane widget demo.',
      args: [value],
    );
  }

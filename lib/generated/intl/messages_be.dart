...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(repoLink) =>
      "Каб праглядзець зыходны код гэтай праграмы, акрыйце старонку ${repoLink}.";

  static String m1(title) => "Запаўняльнік для ўкладкі ${title}";

  static String m2(destinationName) => "Азнаёмцеся з: ${destinationName}";

  static String m3(destinationName) => "Абагульце: ${destinationName}";
  ...
  static String m10(value) => "${value} з мёдам";

  static String m11(value) => "${value} з цукрам";

  static String m12(value) => "Элемент ${value}";

  static String m13(error) => "Не ўдалося скапіраваць у буфер абмену: ${error}";

  static String m14(value) => "Непарыўны: ${value}";

  static String m15(value) => "Дыскрэтны: ${value}";

  static String m16(value) => "Пазначана: ${value}";

  static String m17(value) => "Выбрана: ${value}";

  static String m18(name, phoneNumber) =>
      "Нумар тэлефона карыстальніка ${name}: ${phoneNumber}";

  static String m19(value) => "Элемент ${value}";

  static String m20(value) => "Падрабязныя звесткі пра элемент ${value}";

  static String m21(value) => "Вы выбралі: \"${value}\"";

  static String m22(repoName) => "Рэпазітар GitHub ${repoName}";
  ...
  static String m27(amount) =>
      "На гэтым тыдні вы выдаткавалі ${amount} на рэстараны.";
  ...
  static String m33(quantity) => "Колькасць: ${quantity}";
  ...
  static String m35(product) => "Выдаліць прадукт: ${product}";

  static String m36(value) => "Элемент ${value}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "demo": MessageLookupByLibrary.simpleMessage("Дэмаверсія"),
        ...
        "demoAppBarTitle":
            MessageLookupByLibrary.simpleMessage("Панэль праграм"),
        ...
        "demoContainerTransformModalBottomSheetTitle":
            MessageLookupByLibrary.simpleMessage("Рэжым затухання"),
        "demoContainerTransformTitle":
            MessageLookupByLibrary.simpleMessage("Пераўтварэнне кантэйнера"),
        "demoContainerTransformTypeFade":
            MessageLookupByLibrary.simpleMessage("ЗАТУХАННЕ"),
        "demoContainerTransformTypeFadeThrough":
            MessageLookupByLibrary.simpleMessage("ПАСТУПОВАЕ ЗМЯНЕННЕ"),
        ...
        "demoCupertinoContextMenuActionOne":
            MessageLookupByLibrary.simpleMessage("Першае дзеянне"),
        ...
        "demoCupertinoContextMenuActionTwo":
            MessageLookupByLibrary.simpleMessage("Другое дзеянне"),
        ...
        "demoCupertinoPicker":
            MessageLookupByLibrary.simpleMessage("Інструмент выбару"),
        ...
        "demoCupertinoPickerSubtitle": MessageLookupByLibrary.simpleMessage(
            "Інструменты выбару ў стылі iOS"),
        ...
        "demoCupertinoScrollbarTitle":
            MessageLookupByLibrary.simpleMessage("Паласа прагортвання"),
        ...
        "demoCupertinoSearchTextFieldPlaceholder":
            MessageLookupByLibrary.simpleMessage("Увядзіце пошукавы тэрмін"),
        "demoCupertinoSearchTextFieldSubtitle":
            MessageLookupByLibrary.simpleMessage(
                "Поле крытэрыю пошуку ў стылі iOS"),
        "demoCupertinoSearchTextFieldTitle":
            MessageLookupByLibrary.simpleMessage("Поле крытэрыю пошуку"),
        ...
        "demoDateRangePickerTitle":
            MessageLookupByLibrary.simpleMessage("Сродак выбару дыяпазону дат"),
        ...
        "demoDividerTitle":
            MessageLookupByLibrary.simpleMessage("Раздзяляльнік"),
        ...
        "demoElevatedButtonTitle":
            MessageLookupByLibrary.simpleMessage("Прыпаднятая кнопка"),
        "demoFadeScaleAlertDialogCancelButton":
            MessageLookupByLibrary.simpleMessage("СКАСАВАЦЬ"),
        "demoFadeScaleAlertDialogDiscardButton":
            MessageLookupByLibrary.simpleMessage("АДХІЛІЦЬ"),
        "demoFadeScaleAlertDialogHeader":
            MessageLookupByLibrary.simpleMessage("Дыялогавае акно абвесткі"),
        ...
        "demoFadeScaleHideFabButton": MessageLookupByLibrary.simpleMessage(
            "СХАВАЦЬ РУХОМУЮ КНОПКУ ДЗЕЯННЯ"),
        "demoFadeScaleShowAlertDialogButton":
            MessageLookupByLibrary.simpleMessage("ПАКАЗАЦЬ МАДАЛЬНАЕ АКНО"),
        "demoFadeScaleShowFabButton": MessageLookupByLibrary.simpleMessage(
            "ПАКАЗАЦЬ РУХОМУЮ КНОПКУ ДЗЕЯННЯ"),
        "demoFadeScaleTitle": MessageLookupByLibrary.simpleMessage("Затуханне"),
        ...
        "demoMotionDetailsPageTitle": MessageLookupByLibrary.simpleMessage(
            "Старонка падрабязных звестак"),
        "demoMotionListTileTitle":
            MessageLookupByLibrary.simpleMessage("Элемент спіса"),
        "demoMotionPlaceholderSubtitle":
            MessageLookupByLibrary.simpleMessage("Другасны тэкст"),
        "demoMotionPlaceholderTitle":
            MessageLookupByLibrary.simpleMessage("Назва"),
        "demoMotionSmallPlaceholderSubtitle":
            MessageLookupByLibrary.simpleMessage("Другасны"),
        "demoMotionSubtitle": MessageLookupByLibrary.simpleMessage(
            "Усе стандартныя шаблоны пераходу"),
        "demoMotionTitle": MessageLookupByLibrary.simpleMessage("Рух"),
        ...
        "demoNavigationDrawerTitle":
            MessageLookupByLibrary.simpleMessage("Высоўнае меню навігацыі"),
        "demoNavigationDrawerToPageOne":
            MessageLookupByLibrary.simpleMessage("Першы элемент"),
        "demoNavigationDrawerToPageTwo":
            MessageLookupByLibrary.simpleMessage("Другі элемент"),
        ...
        "demoNavigationRailFirst":
            MessageLookupByLibrary.simpleMessage("Першая"),
        "demoNavigationRailSecond":
            MessageLookupByLibrary.simpleMessage("Другая"),
        "demoNavigationRailSubtitle": MessageLookupByLibrary.simpleMessage(
            "Паказ планкі навігацыі ў праграме"),
        "demoNavigationRailThird":
            MessageLookupByLibrary.simpleMessage("Трэцяя"),
        "demoNavigationRailTitle":
            MessageLookupByLibrary.simpleMessage("Планка навігацыі"),
        ...
        "demoSharedXAxisCoursePageTitle":
            MessageLookupByLibrary.simpleMessage("Аптымізуйце свае кірункі"),
        ...
        "demoSharedXAxisSignInWelcomeText":
            MessageLookupByLibrary.simpleMessage("Вітаем у David Park"),
        "demoSharedXAxisTitle":
            MessageLookupByLibrary.simpleMessage("Абагуленая вось x"),
        "demoSharedYAxisAlbumCount":
            MessageLookupByLibrary.simpleMessage("268 альбомаў"),
        "demoSharedYAxisAlbumTileDurationUnit":
            MessageLookupByLibrary.simpleMessage("хв"),
        "demoSharedYAxisAlbumTileSubtitle":
            MessageLookupByLibrary.simpleMessage("Выканаўца"),
        ...
        "demoSharedYAxisRecentSortTitle":
            MessageLookupByLibrary.simpleMessage("Нядаўна прайгравалася"),
        "demoSharedYAxisTitle":
            MessageLookupByLibrary.simpleMessage("Абагуленая вось y"),
        "demoSharedZAxisBeefSandwichRecipeDescription":
            MessageLookupByLibrary.simpleMessage(
                "Рэцэпт сандвіча з ялавічынай"),
        "demoSharedZAxisBeefSandwichRecipeTitle":
            MessageLookupByLibrary.simpleMessage("Сандвіч з ялавічынай"),
        "demoSharedZAxisBurgerRecipeDescription":
            MessageLookupByLibrary.simpleMessage("Рэцэпт бургера"),
        "demoSharedZAxisBurgerRecipeTitle":
            MessageLookupByLibrary.simpleMessage("Бургер"),
        "demoSharedZAxisCrabPlateRecipeDescription":
            MessageLookupByLibrary.simpleMessage("Рэцэпт асарці з крабам"),
        "demoSharedZAxisCrabPlateRecipeTitle":
            MessageLookupByLibrary.simpleMessage("Краб"),
        "demoSharedZAxisDemoInstructions":
            MessageLookupByLibrary.simpleMessage("Кнопка са значком налад"),
        "demoSharedZAxisDessertRecipeDescription":
            MessageLookupByLibrary.simpleMessage("Рэцэпт дэсерта"),
        "demoSharedZAxisDessertRecipeTitle":
            MessageLookupByLibrary.simpleMessage("Дэсерт"),
        "demoSharedZAxisHelpSettingLabel":
            MessageLookupByLibrary.simpleMessage("Даведка"),
        ...
        "demoSharedZAxisPrivacySettingLabel":
            MessageLookupByLibrary.simpleMessage("Прыватнасць"),
        "demoSharedZAxisProfileSettingLabel":
            MessageLookupByLibrary.simpleMessage("Профіль"),
        "demoSharedZAxisSandwichRecipeDescription":
            MessageLookupByLibrary.simpleMessage("Рэцэпт сандвіча"),
        "demoSharedZAxisSandwichRecipeTitle":
            MessageLookupByLibrary.simpleMessage("Сандвіч"),
        "demoSharedZAxisSavedRecipesListTitle":
            MessageLookupByLibrary.simpleMessage("Захаваныя рэцэпты"),
        "demoSharedZAxisSettingsPageTitle":
            MessageLookupByLibrary.simpleMessage("Налады"),
        "demoSharedZAxisShrimpPlateRecipeDescription":
            MessageLookupByLibrary.simpleMessage("Рэцэпт асарці з крэветкамі"),
        "demoSharedZAxisShrimpPlateRecipeTitle":
            MessageLookupByLibrary.simpleMessage("Крэветкі"),
        "demoSharedZAxisTitle":
            MessageLookupByLibrary.simpleMessage("Абагуленая вось z"),
        ...
        "demoTextButtonTitle":
            MessageLookupByLibrary.simpleMessage("Тэкставая кнопка"),
        ...
        "demoTwoPaneDetails":
            MessageLookupByLibrary.simpleMessage("Падрабязныя звесткі"),
        ...
        "demoTwoPaneFoldableLabel":
            MessageLookupByLibrary.simpleMessage("Складваецца"),
        "demoTwoPaneItem": m19,
        "demoTwoPaneItemDetails": m20,
        "demoTwoPaneList": MessageLookupByLibrary.simpleMessage("Спіс"),
        "demoTwoPaneSelectItem":
            MessageLookupByLibrary.simpleMessage("Выберыце элемент"),
        "demoTwoPaneSmallScreenDescription":
            MessageLookupByLibrary.simpleMessage(
                "Вось так TwoPane выглядае на прыладзе з малым экранам."),
        "demoTwoPaneSmallScreenLabel":
            MessageLookupByLibrary.simpleMessage("Малы экран"),
        ...
        "demoTwoPaneTabletLabel":
            MessageLookupByLibrary.simpleMessage("Планшэт / ПК"),
        ...
        "demoVerticalDividerTitle":
            MessageLookupByLibrary.simpleMessage("Вертыкальны раздзяляльнік"),
        "deselect": MessageLookupByLibrary.simpleMessage("Скасаваць выбар"),
        "dialogAddAccount":
        ...
        "replyDraftsLabel": MessageLookupByLibrary.simpleMessage("Чарнавікі"),
        "replyInboxLabel": MessageLookupByLibrary.simpleMessage("Уваходныя"),
        "replySentLabel": MessageLookupByLibrary.simpleMessage("Адпраўленыя"),
        "replySpamLabel": MessageLookupByLibrary.simpleMessage("Спам"),
        "replyStarredLabel": MessageLookupByLibrary.simpleMessage("Пазначаныя"),
        "replyTrashLabel": MessageLookupByLibrary.simpleMessage("Сметніца"),
        ...
        "splashSelectDemo":
            MessageLookupByLibrary.simpleMessage("Выберыце дэманстрацыю"),

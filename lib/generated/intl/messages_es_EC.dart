...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(repoLink) =>
      "Para ver el código fuente de esta app, visita ${repoLink}.";
  ...
  static String m13(error) => "No se pudo copiar al portapapeles: ${error}";

  static String m14(value) => "Continuo: ${value}";

  static String m15(value) => "Discreto: ${value}";
  ...
  static String m19(value) => "Artículo ${value}";

  static String m20(value) => "Detalles del artículo ${value}";

  static String m21(value) => "Seleccionaste: \"${value}\"";
  ...
  static String m27(amount) =>
      "Esta semana, gastaste ${amount} en restaurantes.";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "demo": MessageLookupByLibrary.simpleMessage("Demostración"),
        ...
        "demoAppBarDescription": MessageLookupByLibrary.simpleMessage(
            "La barra de la app incluye contenido y acciones relacionadas a la pantalla actual. Se usa para desarrollo de la marca, títulos en pantalla, navegación y acciones."),
        "demoAppBarSubtitle": MessageLookupByLibrary.simpleMessage(
            "Muestra información y acciones relacionadas a la pantalla actual"),
        "demoAppBarTitle":
            MessageLookupByLibrary.simpleMessage("Barra de la aplicación"),
        ...
        "demoContainerTransformDemoInstructions":
            MessageLookupByLibrary.simpleMessage("Tarjetas, Listas y BAF"),
        ...
        "demoContainerTransformTypeFade":
            MessageLookupByLibrary.simpleMessage("ATENUACIÓN"),
        "demoContainerTransformTypeFadeThrough":
            MessageLookupByLibrary.simpleMessage("ATENUACIÓN RÁPIDA"),
        ...
        "demoCupertinoActivityIndicatorDescription":
            MessageLookupByLibrary.simpleMessage(
                "Corresponde a un indicador de actividad de estilo iOS que gira en el sentido de las manecillas del reloj."),
        ...
        "demoCupertinoContextMenuActionOne":
            MessageLookupByLibrary.simpleMessage("Acción uno"),
        "demoCupertinoContextMenuActionText": MessageLookupByLibrary.simpleMessage(
            "Mantén presionado el logotipo de Flutter para ver el menú contextual."),
        "demoCupertinoContextMenuActionTwo":
            MessageLookupByLibrary.simpleMessage("Acción dos"),
        "demoCupertinoContextMenuDescription": MessageLookupByLibrary.simpleMessage(
            "Un menú contextual de pantalla completa con estilo de iOS que aparece cuando se mantiene presionado un elemento."),
        "demoCupertinoContextMenuSubtitle":
            MessageLookupByLibrary.simpleMessage(
                "Menú contextual con estilo de iOS"),
        ...
        "demoCupertinoPickerDescription": MessageLookupByLibrary.simpleMessage(
            "Corresponde al widget de un selector similar al de iOS que se puede usar para elegir strings, fechas, horas, o tanto fechas como horas."),
        ...
        "demoCupertinoScrollbarDescription": MessageLookupByLibrary.simpleMessage(
            "Es una barra de desplazamiento que une el elemento secundario proporcionado."),
        ...
        "demoCupertinoSearchTextFieldDescription":
            MessageLookupByLibrary.simpleMessage(
                "Es un campo de texto de búsqueda que permite al usuario ingresar texto para hacer búsquedas y que puede ofrecer y filtrar sugerencias."),
        "demoCupertinoSearchTextFieldPlaceholder":
            MessageLookupByLibrary.simpleMessage("Ingresa texto"),
        "demoCupertinoSearchTextFieldSubtitle":
            MessageLookupByLibrary.simpleMessage(
                "Campo de texto de búsqueda similar al de iOS"),
        "demoCupertinoSearchTextFieldTitle":
            MessageLookupByLibrary.simpleMessage("Campo de texto de búsqueda"),
        ...
        "demoDateRangePickerDescription": MessageLookupByLibrary.simpleMessage(
            "Muestra un diálogo que contiene un selector de períodos de Material Design."),
        "demoDateRangePickerTitle":
            MessageLookupByLibrary.simpleMessage("Selector de períodos"),
        ...
        "demoDividerDescription": MessageLookupByLibrary.simpleMessage(
            "Un divisor se puede usar en listas, paneles laterales y cualquier otro lugar para separar contenido."),
        "demoDividerSubtitle": MessageLookupByLibrary.simpleMessage(
            "Un divisor es una línea fina que agrupa contenido en listas y paneles."),
        ...
        "demoElevatedButtonDescription": MessageLookupByLibrary.simpleMessage(
            "Los botones con relieve agregan profundidad a los diseños que son principalmente planos. Destacan las funciones en espacios amplios o con muchos elementos."),
        ...
        "demoFadeScaleDemoInstructions":
            MessageLookupByLibrary.simpleMessage("Modal y BAF"),
        ...
        "demoFadeScaleShowAlertDialogButton":
            MessageLookupByLibrary.simpleMessage("MOSTRAR CUADRO"),
        "demoFadeScaleShowFabButton":
            MessageLookupByLibrary.simpleMessage("MOSTRAR BAF"),
        "demoFadeScaleTitle":
            MessageLookupByLibrary.simpleMessage("Atenuación"),
        ...
        "demoMotionListTileTitle":
            MessageLookupByLibrary.simpleMessage("Elemento de la lista"),
        ...
        "demoNavigationDrawerDescription": MessageLookupByLibrary.simpleMessage(
            "Un panel de Material Design que se desliza horizontalmente desde el borde de la pantalla para mostrar vínculos de navegación en una aplicación."),
        "demoNavigationDrawerSubtitle": MessageLookupByLibrary.simpleMessage(
            "Cómo mostrar un panel lateral dentro de la barra de la app"),
        "demoNavigationDrawerText": MessageLookupByLibrary.simpleMessage(
            "Desliza el dedo desde el borde o presiona el ícono superior izquierdo para ver el panel lateral"),
        "demoNavigationDrawerTitle":
            MessageLookupByLibrary.simpleMessage("Panel lateral de navegación"),
        ...
        "demoNavigationRailDescription": MessageLookupByLibrary.simpleMessage(
            "Un widget de Material que debe mostrarse a la izquierda o la derecha de una app para navegar entre una pequeña cantidad de vistas, generalmente entre tres y cinco."),
        ...
        "demoNavigationRailSubtitle": MessageLookupByLibrary.simpleMessage(
            "Cómo mostrar un riel de navegación dentro de una app"),
        "demoNavigationRailThird":
            MessageLookupByLibrary.simpleMessage("Tercera"),
        "demoNavigationRailTitle":
            MessageLookupByLibrary.simpleMessage("Riel de navegación"),
        ...
        "demoSelectionControlsSwitchDescription":
            MessageLookupByLibrary.simpleMessage(
                "Los interruptores de activado/desactivado cambian el estado de un único parámetro de configuración. La opción que controla el interruptor, como también el estado en que se encuentra, debería resultar evidente desde la etiqueta intercalada correspondiente."),
        ...
        "demoSharedXAxisCoursePageTitle":
            MessageLookupByLibrary.simpleMessage("Optimiza los cursos"),
        ...
        "demoSharedXAxisCulinaryCourseTitle":
            MessageLookupByLibrary.simpleMessage("Cocina"),
        "demoSharedXAxisDemoInstructions":
            MessageLookupByLibrary.simpleMessage("Botones Atrás y Siguiente"),
        ...
        "demoSharedXAxisIndividualCourseSubtitle":
            MessageLookupByLibrary.simpleMessage("Mostrados por separado"),
        "demoSharedXAxisNextButtonText":
            MessageLookupByLibrary.simpleMessage("SIGUIENTE"),
        "demoSharedXAxisSignInSubtitleText":
            MessageLookupByLibrary.simpleMessage("Accede con tu cuenta"),
        ...
        "demoSharedYAxisDemoInstructions": MessageLookupByLibrary.simpleMessage(
            "Ordenado por \"Reproducido recientemente\""),
        ...
        "demoSharedZAxisBeefSandwichRecipeTitle":
            MessageLookupByLibrary.simpleMessage("Sándwich de carne de res"),
        ...
        "demoSharedZAxisDemoInstructions": MessageLookupByLibrary.simpleMessage(
            "Botón de ícono de configuración"),
        ...
        "demoSharedZAxisSandwichRecipeDescription":
            MessageLookupByLibrary.simpleMessage("Receta de sándwich"),
        ...
        "demoTwoPaneFoldableDescription": MessageLookupByLibrary.simpleMessage(
            "Así es cómo se comporta TwoPane en un dispositivo plegable."),
        ...
        "demoTwoPaneSmallScreenDescription": MessageLookupByLibrary.simpleMessage(
            "Así es como se comporta TwoPane en un dispositivo con pantalla pequeña."),
        ...
        "demoTwoPaneSubtitle": MessageLookupByLibrary.simpleMessage(
            "Diseño responsivo en pantallas plegables, grandes y pequeñas"),
        "demoTwoPaneTabletDescription": MessageLookupByLibrary.simpleMessage(
            "Así es como se comporta TwoPane en una pantalla de mayor tamaño, como la de una tablet o una computadora."),
        "demoTwoPaneTabletLabel":
            MessageLookupByLibrary.simpleMessage("Tablet/computadora"),
        ...
        "deselect": MessageLookupByLibrary.simpleMessage("Anular selección"),
        "dialogAddAccount":
        ...
        "notSelected": MessageLookupByLibrary.simpleMessage("Sin seleccionar"),
        ...
        "replyDescription": MessageLookupByLibrary.simpleMessage(
            "Una app de correo electrónico especializada y eficiente"),
        "replyDraftsLabel": MessageLookupByLibrary.simpleMessage("Borradores"),
        "replyInboxLabel": MessageLookupByLibrary.simpleMessage("Recibidos"),
        ...
        "splashSelectDemo":
            MessageLookupByLibrary.simpleMessage("Selecciona una demostración"),
        ...
        "starterAppGenericTitle":
            MessageLookupByLibrary.simpleMessage("Título"),
        "starterAppTitle":
            MessageLookupByLibrary.simpleMessage("App de partida"),

...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(repoLink) => "如要查看這個應用程式的原始碼，請前往 ${repoLink}。";

  static String m1(title) => "「${title}」分頁的預留位置";
  ...
  static String m10(value) => "「${value}」加蜂蜜";

  static String m11(value) => "「${value}」加糖";

  static String m12(value) => "商品：${value}";

  static String m13(error) => "無法複製到剪貼簿：${error}";

  static String m14(value) => "連續值：${value}";

  static String m15(value) => "離散值：${value}";

  static String m16(value) => "已勾選：${value}";

  static String m17(value) => "已選取：${value}";

  static String m18(name, phoneNumber) => "${name}的電話號碼為 ${phoneNumber}";

  static String m19(value) => "項目 ${value}";

  static String m20(value) => "項目 ${value} 的詳細資料";

  static String m21(value) => "你已選取：「${value}」";

  static String m22(repoName) => "${repoName} GitHub 存放區";

  static String m23(accountName, accountNumber, amount) =>
      "${accountName}帳戶 ${accountNumber} 的存款金額為 ${amount}。";

  static String m24(amount) => "你這個月支出了 ${amount} 的自動提款機手續費";

  static String m25(percent) => "好極了！你的支票帳戶比上個月高出 ${percent}。";

  static String m26(percent) => "請注意，你已使用本月購物預算的 ${percent}。";

  static String m27(amount) => "你本週在餐廳消費了 ${amount}。";
  ...
  static String m33(quantity) => "數量：${quantity}";
  ...
  static String m36(value) => "商品：${value}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "bottomAppBar": MessageLookupByLibrary.simpleMessage("底部應用程式列"),
        ...
        "demo": MessageLookupByLibrary.simpleMessage("示範模式"),
        ...
        "demoAppBarSubtitle":
            MessageLookupByLibrary.simpleMessage("顯示與目前畫面相關的資訊和動作"),
        "demoAppBarTitle": MessageLookupByLibrary.simpleMessage("應用程式列"),
        ...
        "demoButtonSubtitle":
            MessageLookupByLibrary.simpleMessage("文字、升起效果、外框和其他設計元素"),
        ...
        "demoColorsDescription": MessageLookupByLibrary.simpleMessage(
            "代表 Material Design 調色盤的顏色和色樣常數。"),
        ...
        "demoContainerTransformDemoInstructions":
            MessageLookupByLibrary.simpleMessage("卡片、清單和懸浮動作按鈕 (FAB)"),
        ...
        "demoContainerTransformTitle":
            MessageLookupByLibrary.simpleMessage("容器轉換"),
        "demoContainerTransformTypeFade":
            MessageLookupByLibrary.simpleMessage("淡化"),
        "demoContainerTransformTypeFadeThrough":
            MessageLookupByLibrary.simpleMessage("淡出淡入切換"),
        ...
        "demoCupertinoContextMenuActionOne":
            MessageLookupByLibrary.simpleMessage("動作一"),
        "demoCupertinoContextMenuActionText":
            MessageLookupByLibrary.simpleMessage("按住 Flutter 標誌即可查看內容選單。"),
        "demoCupertinoContextMenuActionTwo":
            MessageLookupByLibrary.simpleMessage("動作二"),
        "demoCupertinoContextMenuDescription":
            MessageLookupByLibrary.simpleMessage(
                "長按某個元素時，畫面上就會出現 iOS 樣式的全螢幕內容選單。"),
        "demoCupertinoContextMenuSubtitle":
            MessageLookupByLibrary.simpleMessage("iOS 樣式的內容選單"),
        "demoCupertinoContextMenuTitle":
            MessageLookupByLibrary.simpleMessage("內容選單"),
        ...
        "demoCupertinoPicker": MessageLookupByLibrary.simpleMessage("挑選器"),
        ...
        "demoCupertinoPickerSubtitle":
            MessageLookupByLibrary.simpleMessage("iOS 樣式的挑選器"),
        ...
        "demoCupertinoScrollbarDescription":
            MessageLookupByLibrary.simpleMessage("納入指定子項的捲軸"),
        "demoCupertinoScrollbarSubtitle":
            MessageLookupByLibrary.simpleMessage("iOS 樣式的捲軸"),
        "demoCupertinoScrollbarTitle":
            MessageLookupByLibrary.simpleMessage("捲軸"),
        ...
        "demoCupertinoSearchTextFieldSubtitle":
            MessageLookupByLibrary.simpleMessage("iOS 樣式的搜尋文字欄位"),
        "demoCupertinoSearchTextFieldTitle":
            MessageLookupByLibrary.simpleMessage("搜尋文字欄位"),
        ...
        "demoCupertinoSwitchDescription":
            MessageLookupByLibrary.simpleMessage("你可以使用切換鈕切換單一設定的開啟/關閉狀態。"),
        "demoCupertinoSwitchSubtitle":
            MessageLookupByLibrary.simpleMessage("iOS 樣式切換鈕"),
        ...
        "demoDatePickerDescription": MessageLookupByLibrary.simpleMessage(
            "顯示內含 Material Design 日期挑選器的對話方塊。"),
        ...
        "demoDateRangePickerTitle":
            MessageLookupByLibrary.simpleMessage("日期範圍挑選器"),
        ...
        "demoDividerDescription":
            MessageLookupByLibrary.simpleMessage("分隔線可用來分隔清單、導覽匣等內容。"),
        "demoDividerSubtitle":
            MessageLookupByLibrary.simpleMessage("分隔線是一條細線，可分類清單及版面配置中的內容。"),
        "demoDividerTitle": MessageLookupByLibrary.simpleMessage("分隔線"),
        ...
        "demoElevatedButtonTitle":
            MessageLookupByLibrary.simpleMessage("升起效果按鈕"),
        "demoFadeScaleAlertDialogCancelButton":
            MessageLookupByLibrary.simpleMessage("取消"),
        "demoFadeScaleAlertDialogDiscardButton":
            MessageLookupByLibrary.simpleMessage("捨棄"),
        "demoFadeScaleAlertDialogHeader":
            MessageLookupByLibrary.simpleMessage("快訊對話方塊"),
        "demoFadeScaleDemoInstructions":
            MessageLookupByLibrary.simpleMessage("強制回應和懸浮動作按鈕 (FAB)"),
        ...
        "demoFadeScaleHideFabButton":
            MessageLookupByLibrary.simpleMessage("隱藏懸浮動作按鈕 (FAB)"),
        "demoFadeScaleShowAlertDialogButton":
            MessageLookupByLibrary.simpleMessage("顯示強制回應對話方塊"),
        "demoFadeScaleShowFabButton":
            MessageLookupByLibrary.simpleMessage("顯示懸浮動作按鈕 (FAB)"),
        "demoFadeScaleTitle": MessageLookupByLibrary.simpleMessage("淡化"),
        "demoFadeThroughAlbumsDestination":
            MessageLookupByLibrary.simpleMessage("相簿"),
        "demoFadeThroughDemoInstructions":
            MessageLookupByLibrary.simpleMessage("底部導覽"),
        "demoFadeThroughDescription": MessageLookupByLibrary.simpleMessage(
            "淡出淡入切換模式可用於轉換彼此間沒有緊密關係的 UI 元素。"),
        "demoFadeThroughPhotosDestination":
            MessageLookupByLibrary.simpleMessage("相片"),
        "demoFadeThroughSearchDestination":
            MessageLookupByLibrary.simpleMessage("搜尋"),
        "demoFadeThroughTextPlaceholder":
            MessageLookupByLibrary.simpleMessage("123 張相片"),
        "demoFadeThroughTitle": MessageLookupByLibrary.simpleMessage("淡出淡入切換"),
        ...
        "demoMotionDetailsPageTitle":
            MessageLookupByLibrary.simpleMessage("詳細資料頁面"),
        "demoMotionListTileTitle": MessageLookupByLibrary.simpleMessage("清單項目"),
        "demoMotionPlaceholderSubtitle":
            MessageLookupByLibrary.simpleMessage("次要文字"),
        "demoMotionPlaceholderTitle":
            MessageLookupByLibrary.simpleMessage("標題"),
        "demoMotionSmallPlaceholderSubtitle":
            MessageLookupByLibrary.simpleMessage("次要"),
        "demoMotionSubtitle":
            MessageLookupByLibrary.simpleMessage("所有預先定義的轉換模式"),
        "demoMotionTitle": MessageLookupByLibrary.simpleMessage("動態效果"),
        ...
        "demoNavigationDrawerSubtitle":
            MessageLookupByLibrary.simpleMessage("在應用程式列內顯示導覽匣"),
        "demoNavigationDrawerText":
            MessageLookupByLibrary.simpleMessage("從邊緣滑動或輕觸左上角圖示即可查看導覽匣"),
        "demoNavigationDrawerTitle":
            MessageLookupByLibrary.simpleMessage("導覽匣"),
        "demoNavigationDrawerToPageOne":
            MessageLookupByLibrary.simpleMessage("項目一"),
        "demoNavigationDrawerToPageTwo":
            MessageLookupByLibrary.simpleMessage("項目二"),
        ...
        "demoNavigationRailFirst": MessageLookupByLibrary.simpleMessage("第一個"),
        "demoNavigationRailSecond": MessageLookupByLibrary.simpleMessage("第二個"),
        "demoNavigationRailSubtitle":
            MessageLookupByLibrary.simpleMessage("在應用程式內顯示導覽邊欄"),
        "demoNavigationRailThird": MessageLookupByLibrary.simpleMessage("第三個"),
        "demoNavigationRailTitle": MessageLookupByLibrary.simpleMessage("導覽邊欄"),
        ...
        "demoOutlinedButtonTitle": MessageLookupByLibrary.simpleMessage("外框按鈕"),
        ...
        "demoSelectionControlsSubtitle":
            MessageLookupByLibrary.simpleMessage("核取方塊、圓形按鈕和切換鈕"),
        "demoSelectionControlsSwitchDescription":
            MessageLookupByLibrary.simpleMessage(
                "「開啟/關閉」切換鈕是用來切換單一設定選項的狀態。切換鈕控制的選項及其目前狀態都應在對應的內嵌標籤上清楚顯示。"),
        "demoSelectionControlsSwitchTitle":
            MessageLookupByLibrary.simpleMessage("切換鈕"),
        ...
        "demoSharedXAxisArtsAndCraftsCourseTitle":
            MessageLookupByLibrary.simpleMessage("藝術與工藝"),
        "demoSharedXAxisBackButtonText":
            MessageLookupByLibrary.simpleMessage("返回"),
        "demoSharedXAxisBundledCourseSubtitle":
            MessageLookupByLibrary.simpleMessage("組合"),
        "demoSharedXAxisBusinessCourseTitle":
            MessageLookupByLibrary.simpleMessage("商業"),
        "demoSharedXAxisCoursePageSubtitle":
            MessageLookupByLibrary.simpleMessage(
                "組合類別會以群組方式顯示在動態饋給中，你之後隨時可以進行變更。"),
        "demoSharedXAxisCoursePageTitle":
            MessageLookupByLibrary.simpleMessage("將課程化繁為簡"),
        "demoSharedXAxisCreateAccountButtonText":
            MessageLookupByLibrary.simpleMessage("建立帳戶"),
        "demoSharedXAxisCulinaryCourseTitle":
            MessageLookupByLibrary.simpleMessage("烹飪"),
        "demoSharedXAxisDemoInstructions":
            MessageLookupByLibrary.simpleMessage("繼續和返回按鈕"),
        "demoSharedXAxisDesignCourseTitle":
            MessageLookupByLibrary.simpleMessage("設計"),
        "demoSharedXAxisForgotEmailButtonText":
            MessageLookupByLibrary.simpleMessage("忘記電子郵件地址？"),
        "demoSharedXAxisIllustrationCourseTitle":
            MessageLookupByLibrary.simpleMessage("插圖"),
        "demoSharedXAxisIndividualCourseSubtitle":
            MessageLookupByLibrary.simpleMessage("個別顯示"),
        "demoSharedXAxisNextButtonText":
            MessageLookupByLibrary.simpleMessage("繼續"),
        "demoSharedXAxisSignInSubtitleText":
            MessageLookupByLibrary.simpleMessage("登入帳戶"),
        "demoSharedXAxisSignInTextFieldLabel":
            MessageLookupByLibrary.simpleMessage("電子郵件地址或電話號碼"),
        "demoSharedXAxisSignInWelcomeText":
            MessageLookupByLibrary.simpleMessage("David Park 你好"),
        "demoSharedXAxisTitle": MessageLookupByLibrary.simpleMessage("共用 X 軸"),
        "demoSharedYAxisAlbumCount":
            MessageLookupByLibrary.simpleMessage("268 張專輯"),
        "demoSharedYAxisAlbumTileDurationUnit":
            MessageLookupByLibrary.simpleMessage("分鐘"),
        "demoSharedYAxisAlbumTileSubtitle":
            MessageLookupByLibrary.simpleMessage("演出者"),
        ...
        "demoTextButtonTitle": MessageLookupByLibrary.simpleMessage("文字按鈕"),
        ...
        "demoTimePickerDescription": MessageLookupByLibrary.simpleMessage(
            "顯示內含 Material Design 時間挑選器的對話方塊。"),
        ...
        "demoTwoPaneDetails": MessageLookupByLibrary.simpleMessage("詳細資料"),
        "demoTwoPaneFoldableDescription":
            MessageLookupByLibrary.simpleMessage("這是 TwoPane 在折疊式裝置上的運作方式。"),
        "demoTwoPaneFoldableLabel":
            MessageLookupByLibrary.simpleMessage("折疊式裝置"),
        "demoTwoPaneItem": m19,
        "demoTwoPaneItemDetails": m20,
        "demoTwoPaneList": MessageLookupByLibrary.simpleMessage("清單"),
        "demoTwoPaneSelectItem": MessageLookupByLibrary.simpleMessage("選取項目"),
        "demoTwoPaneSmallScreenDescription":
            MessageLookupByLibrary.simpleMessage("這是 TwoPane 在小螢幕裝置上的運作方式。"),
        "demoTwoPaneSmallScreenLabel":
            MessageLookupByLibrary.simpleMessage("小螢幕"),
        "demoTwoPaneSubtitle":
            MessageLookupByLibrary.simpleMessage("在折疊式裝置、大螢幕和小螢幕上的回應式版面配置"),
        "demoTwoPaneTabletDescription": MessageLookupByLibrary.simpleMessage(
            "這是 TwoPane 在平板電腦或電腦這類大螢幕裝置上的運作方式。"),
        "demoTwoPaneTabletLabel":
            MessageLookupByLibrary.simpleMessage("平板電腦/電腦"),
        "demoTwoPaneTitle": MessageLookupByLibrary.simpleMessage("TwoPane"),
        "demoTypographyDescription":
            MessageLookupByLibrary.simpleMessage("Material Design 中的多種版面樣式定義。"),
        ...
        "demoVerticalDividerTitle":
            MessageLookupByLibrary.simpleMessage("垂直分隔線"),
        "deselect": MessageLookupByLibrary.simpleMessage("取消選取"),
        ...
        "notSelected": MessageLookupByLibrary.simpleMessage("未選取"),
        ...
        "replyDescription":
            MessageLookupByLibrary.simpleMessage("一款可協助你專注處理事務的高效率電子郵件應用程式"),
        "replyDraftsLabel": MessageLookupByLibrary.simpleMessage("草稿"),
        "replyInboxLabel": MessageLookupByLibrary.simpleMessage("收件匣"),
        "replySentLabel": MessageLookupByLibrary.simpleMessage("已傳送"),
        "replySpamLabel": MessageLookupByLibrary.simpleMessage("垃圾郵件"),
        "replyStarredLabel": MessageLookupByLibrary.simpleMessage("已加星號"),
        "replyTrashLabel": MessageLookupByLibrary.simpleMessage("垃圾桶"),
        "select": MessageLookupByLibrary.simpleMessage("選取"),
        "selectable": MessageLookupByLibrary.simpleMessage("可選取 (長按)"),
        ...
        "splashSelectDemo": MessageLookupByLibrary.simpleMessage("選取示範"),

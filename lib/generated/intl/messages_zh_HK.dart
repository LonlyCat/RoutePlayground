...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(repoLink) => "如要查看此應用程式的原始碼，請前往 ${repoLink}。";

  static String m1(title) => "${title} 分頁嘅佔位符";
  ...
  static String m10(value) => "${value} 伴蜜糖";

  static String m11(value) => "${value} 伴糖";

  static String m12(value) => "項目 ${value}";

  static String m13(error) => "無法複製到剪貼簿：${error}";

  static String m14(value) => "連續：${value}";

  static String m15(value) => "間續：${value}";

  static String m16(value) => "已勾選：${value}";

  static String m17(value) => "已選擇：${value}";

  static String m18(name, phoneNumber) => "${name}的電話號碼是 ${phoneNumber}";

  static String m19(value) => "項目 ${value}";

  static String m20(value) => "項目 ${value} 詳情";

  static String m21(value) => "您已選取：「${value}」";
  ...
  static String m24(amount) => "您這個月已支付 ${amount} 的自動櫃員機費用";

  static String m25(percent) => "做得好！您的支票帳戶結餘比上個月多了 ${percent}。";

  static String m26(percent) => "請注意，您在這個月已經使用了「購物」預算的 ${percent}。";

  static String m27(amount) => "您這個星期已於「餐廳」方面花了 ${amount}。";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "demo": MessageLookupByLibrary.simpleMessage("示範"),
        ...
        "demoAppBarSubtitle":
            MessageLookupByLibrary.simpleMessage("顯示與目前畫面相關的資料和動作"),
        ...
        "demoButtonSubtitle":
            MessageLookupByLibrary.simpleMessage("文字按鈕、凸起的按鈕、外框按鈕等"),
        ...
        "demoCupertinoContextMenuSubtitle":
            MessageLookupByLibrary.simpleMessage("iOS 樣式內容選單"),
        ...
        "demoCupertinoPicker": MessageLookupByLibrary.simpleMessage("點選器"),
        ...
        "demoCupertinoPickerDescription": MessageLookupByLibrary.simpleMessage(
            "iOS 樣式的點選器小工具可用於選擇字串、日期和/或時間。"),
        "demoCupertinoPickerSubtitle":
            MessageLookupByLibrary.simpleMessage("iOS 樣式點選器"),
        ...
        "demoCupertinoScrollbarDescription":
            MessageLookupByLibrary.simpleMessage("捲軸可將特定子節點換行"),
        "demoCupertinoScrollbarSubtitle":
            MessageLookupByLibrary.simpleMessage("iOS 樣式捲軸"),
        ...
        "demoCupertinoSearchTextFieldPlaceholder":
            MessageLookupByLibrary.simpleMessage("輸入文字"),
        ...
        "demoDateRangePickerTitle":
            MessageLookupByLibrary.simpleMessage("日期範圍點選器"),
        ...
        "demoDividerDescription": MessageLookupByLibrary.simpleMessage(
            "分隔線可用分隔內容，無論是清單、導覽列或其他地方均可使用。"),
        "demoDividerSubtitle":
            MessageLookupByLibrary.simpleMessage("分隔線是一條細線，可分隔清單及版面配置中的內容。"),
        ...
        "demoElevatedButtonTitle":
            MessageLookupByLibrary.simpleMessage("凸起的按鈕"),
        ...
        "demoFadeScaleAlertDialogHeader":
            MessageLookupByLibrary.simpleMessage("警示對話框"),
        "demoFadeScaleDemoInstructions":
            MessageLookupByLibrary.simpleMessage("強制回應和懸浮動作按鈕"),
        ...
        "demoFadeScaleHideFabButton":
            MessageLookupByLibrary.simpleMessage("隱藏懸浮動作"),
        "demoFadeScaleShowAlertDialogButton":
            MessageLookupByLibrary.simpleMessage("顯示模態框"),
        "demoFadeScaleShowFabButton":
            MessageLookupByLibrary.simpleMessage("顯示懸浮動作"),
        "demoFadeScaleTitle": MessageLookupByLibrary.simpleMessage("淡出"),
        ...
        "demoFadeThroughDescription":
            MessageLookupByLibrary.simpleMessage("交匯淡出模式用於轉移沒有明確關係的使用者介面元素。"),
        ...
        "demoFadeThroughTitle": MessageLookupByLibrary.simpleMessage("交匯淡出"),
        ...
        "demoMotionDetailsPageTitle":
            MessageLookupByLibrary.simpleMessage("詳情頁面"),
        "demoMotionListTileTitle": MessageLookupByLibrary.simpleMessage("清單項目"),
        "demoMotionPlaceholderSubtitle":
            MessageLookupByLibrary.simpleMessage("次行文字"),
        "demoMotionPlaceholderTitle":
            MessageLookupByLibrary.simpleMessage("標題"),
        "demoMotionSmallPlaceholderSubtitle":
            MessageLookupByLibrary.simpleMessage("次行"),
        "demoMotionSubtitle":
            MessageLookupByLibrary.simpleMessage("所有預先定義的轉移模式"),
        "demoMotionTitle": MessageLookupByLibrary.simpleMessage("動態"),
        ...
        "demoNavigationDrawerSubtitle":
            MessageLookupByLibrary.simpleMessage("在應用程式列中顯示導覽列"),
        "demoNavigationDrawerText":
            MessageLookupByLibrary.simpleMessage("從邊緣滑動或輕按左上方的圖示以查看導覽列"),
        "demoNavigationDrawerTitle":
            MessageLookupByLibrary.simpleMessage("導覽列"),
        "demoNavigationDrawerToPageOne":
            MessageLookupByLibrary.simpleMessage("第一個項目"),
        "demoNavigationDrawerToPageTwo":
            MessageLookupByLibrary.simpleMessage("第二個項目"),
        "demoNavigationDrawerUserEmail":
            MessageLookupByLibrary.simpleMessage("user.name@example.com"),
        "demoNavigationDrawerUserName":
            MessageLookupByLibrary.simpleMessage("用戶名稱"),
        ...
        "demoNavigationRailSubtitle":
            MessageLookupByLibrary.simpleMessage("在應用程式中顯示導覽欄"),
        "demoNavigationRailThird": MessageLookupByLibrary.simpleMessage("第三個"),
        "demoNavigationRailTitle": MessageLookupByLibrary.simpleMessage("導覽欄"),
        ...
        "demoSharedXAxisArtsAndCraftsCourseTitle":
            MessageLookupByLibrary.simpleMessage("藝術與手工藝"),
        ...
        "demoSharedXAxisCoursePageTitle":
            MessageLookupByLibrary.simpleMessage("精簡課程"),
        ...
        "demoSharedYAxisAlbumTileSubtitle":
            MessageLookupByLibrary.simpleMessage("歌手"),
        ...
        "demoSharedZAxisBeefSandwichRecipeDescription":
            MessageLookupByLibrary.simpleMessage("牛肉三文治食譜"),
        "demoSharedZAxisBeefSandwichRecipeTitle":
            MessageLookupByLibrary.simpleMessage("牛肉三文治"),
        "demoSharedZAxisBurgerRecipeDescription":
            MessageLookupByLibrary.simpleMessage("漢堡包食譜"),
        "demoSharedZAxisBurgerRecipeTitle":
            MessageLookupByLibrary.simpleMessage("漢堡包"),
        "demoSharedZAxisCrabPlateRecipeDescription":
            MessageLookupByLibrary.simpleMessage("螃蟹拼盤食譜"),
        ...
        "demoSharedZAxisDessertRecipeDescription":
            MessageLookupByLibrary.simpleMessage("甜品食譜"),
        ...
        "demoSharedZAxisPrivacySettingLabel":
            MessageLookupByLibrary.simpleMessage("私隱"),
        "demoSharedZAxisProfileSettingLabel":
            MessageLookupByLibrary.simpleMessage("個人檔案"),
        "demoSharedZAxisSandwichRecipeDescription":
            MessageLookupByLibrary.simpleMessage("三文治食譜"),
        "demoSharedZAxisSandwichRecipeTitle":
            MessageLookupByLibrary.simpleMessage("三文治"),
        ...
        "demoSharedZAxisShrimpPlateRecipeDescription":
            MessageLookupByLibrary.simpleMessage("鮮蝦拼盤食譜"),
        "demoSharedZAxisShrimpPlateRecipeTitle":
            MessageLookupByLibrary.simpleMessage("蝦"),
        ...
        "demoTwoPaneDetails": MessageLookupByLibrary.simpleMessage("詳情"),
        "demoTwoPaneFoldableDescription":
            MessageLookupByLibrary.simpleMessage("這是 TwoPane 在摺疊式裝置上的行為方式。"),
        "demoTwoPaneFoldableLabel": MessageLookupByLibrary.simpleMessage("摺疊式"),
        "demoTwoPaneItem": m19,
        ...
        "replyDescription":
            MessageLookupByLibrary.simpleMessage("有效率、目標更清晰的電郵應用程式"),
        ...
        "replySpamLabel": MessageLookupByLibrary.simpleMessage("垃圾內容"),
        ...
        "selectable": MessageLookupByLibrary.simpleMessage("可選擇 (長按)"),

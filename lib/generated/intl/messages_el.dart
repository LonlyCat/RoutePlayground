...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(repoLink) =>
      "Για να δείτε τον πηγαίο κώδικα για αυτήν την εφαρμογή, επισκεφτείτε το ${repoLink}.";

  static String m1(title) => "Placeholder για την καρτέλα ${title}";

  static String m2(destinationName) => "Εξερεύνηση ${destinationName}";

  static String m3(destinationName) => "Κοινοποίηση ${destinationName}";
  ...
  static String m7(hours) =>
      "${Intl.plural(hours, one: '1 ώ.', other: '${hours}ώ.')}";
  ...
  static String m10(value) => "${value} με μέλι";

  static String m11(value) => "${value} με ζάχαρη";

  static String m12(value) => "Στοιχείο ${value}";

  static String m13(error) => "Η αντιγραφή στο πρόχειρο απέτυχε: ${error}";

  static String m14(value) => "Συνεχές: ${value}";

  static String m15(value) => "Διακριτό: ${value}";

  static String m16(value) => "Ελέγχθηκε: ${value}";

  static String m17(value) => "Επιλέχθηκε: ${value}";

  static String m18(name, phoneNumber) =>
      "Ο αριθμός τηλεφώνου του χρήστη ${name} είναι ${phoneNumber}";

  static String m19(value) => "Στοιχείο ${value}";

  static String m20(value) => "Λεπτομέρειες στοιχείου ${value}";

  static String m21(value) => "Επιλέξατε \"${value}\"";

  static String m22(repoName) => "${repoName} Χώρος φύλαξης GitHub";
  ...
  static String m33(quantity) => "Ποσότητα: ${quantity}";
  ...
  static String m35(product) => "Κατάργηση ${product}";

  static String m36(value) => "Στοιχείο ${value}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "demo": MessageLookupByLibrary.simpleMessage("Επίδειξη"),
        ...
        "demoAppBarTitle":
            MessageLookupByLibrary.simpleMessage("Γραμμή εφαρμογής"),
        ...
        "demoButtonSubtitle": MessageLookupByLibrary.simpleMessage(
            "Κειμένου, ανυψωμένα, με περίγραμμα κ.α."),
        ...
        "demoContainerTransformDemoInstructions":
            MessageLookupByLibrary.simpleMessage("Κάρτες, λίστες και FAB"),
        ...
        "demoContainerTransformTitle":
            MessageLookupByLibrary.simpleMessage("Μετασχηματισμός κοντέινερ"),
        "demoContainerTransformTypeFade":
            MessageLookupByLibrary.simpleMessage("ΣΤΑΔΙΑΚΗ ΕΞΑΦΑΝΙΣΗ"),
        ...
        "demoCupertinoContextMenuActionOne":
            MessageLookupByLibrary.simpleMessage("Πρώτη ενέργεια"),
        ...
        "demoCupertinoContextMenuActionTwo":
            MessageLookupByLibrary.simpleMessage("Δεύτερη ενέργεια"),
        ...
        "demoCupertinoPicker":
            MessageLookupByLibrary.simpleMessage("Εργαλείο επιλογής"),
        ...
        "demoCupertinoPickerSubtitle":
            MessageLookupByLibrary.simpleMessage("Εργαλεία επιλογής τύπου iOS"),
        ...
        "demoCupertinoScrollbarSubtitle":
            MessageLookupByLibrary.simpleMessage("Γραμμή κύλισης τύπου iOS"),
        "demoCupertinoScrollbarTitle":
            MessageLookupByLibrary.simpleMessage("Γραμμή κύλισης"),
        ...
        "demoCupertinoSearchTextFieldPlaceholder":
            MessageLookupByLibrary.simpleMessage("Καταχωρίστε κείμενο"),
        "demoCupertinoSearchTextFieldSubtitle":
            MessageLookupByLibrary.simpleMessage(
                "Πεδίο κειμένου αναζήτησης τύπου iOS"),
        "demoCupertinoSearchTextFieldTitle":
            MessageLookupByLibrary.simpleMessage("Πεδίο κειμένου αναζήτησης"),
        ...
        "demoDividerTitle":
            MessageLookupByLibrary.simpleMessage("Διαχωριστικό"),
        ...
        "demoFadeScaleTitle":
            MessageLookupByLibrary.simpleMessage("Σταδιακή εξαφάνιση"),
        "demoFadeThroughAlbumsDestination":
            MessageLookupByLibrary.simpleMessage("Άλμπουμ"),
        ...
        "demoMotionDetailsPageTitle":
            MessageLookupByLibrary.simpleMessage("Σελίδα λεπτομερειών"),
        "demoMotionListTileTitle":
            MessageLookupByLibrary.simpleMessage("Στοιχείο λίστας"),
        "demoMotionPlaceholderSubtitle":
            MessageLookupByLibrary.simpleMessage("Δευτερεύον κείμενο"),
        "demoMotionPlaceholderTitle":
            MessageLookupByLibrary.simpleMessage("Τίτλος"),
        "demoMotionSmallPlaceholderSubtitle":
            MessageLookupByLibrary.simpleMessage("Δευτερεύον"),
        "demoMotionSubtitle": MessageLookupByLibrary.simpleMessage(
            "Όλα τα προκαθορισμένα μοτίβα μετάβασης"),
        "demoMotionTitle": MessageLookupByLibrary.simpleMessage("Κίνηση"),
        ...
        "demoNavigationDrawerTitle":
            MessageLookupByLibrary.simpleMessage("Συρτάρι πλοήγησης"),
        "demoNavigationDrawerToPageOne":
            MessageLookupByLibrary.simpleMessage("Στοιχείο ένα"),
        "demoNavigationDrawerToPageTwo":
            MessageLookupByLibrary.simpleMessage("Στοιχείο δύο"),
        ...
        "demoNavigationRailFirst":
            MessageLookupByLibrary.simpleMessage("Πρώτη"),
        "demoNavigationRailSecond":
            MessageLookupByLibrary.simpleMessage("Δεύτερη"),
        ...
        "demoNavigationRailThird":
            MessageLookupByLibrary.simpleMessage("Τρίτη"),
        "demoNavigationRailTitle":
            MessageLookupByLibrary.simpleMessage("Στήλη πλοήγησης"),
        ...
        "demoSharedXAxisArtsAndCraftsCourseTitle":
            MessageLookupByLibrary.simpleMessage("Τέχνη και κατασκευές"),
        "demoSharedXAxisBackButtonText":
            MessageLookupByLibrary.simpleMessage("ΠΙΣΩ"),
        "demoSharedXAxisBundledCourseSubtitle":
            MessageLookupByLibrary.simpleMessage("Ομαδοποιημένο"),
        ...
        "demoSharedXAxisCoursePageTitle": MessageLookupByLibrary.simpleMessage(
            "Συντονισμός των μαθημάτων σας"),
        "demoSharedXAxisCreateAccountButtonText":
            MessageLookupByLibrary.simpleMessage("ΔΗΜΙΟΥΡΓΙΑ ΛΟΓΑΡΙΑΣΜΟΥ"),
        "demoSharedXAxisCulinaryCourseTitle":
            MessageLookupByLibrary.simpleMessage("Μαγειρική"),
        "demoSharedXAxisDemoInstructions":
            MessageLookupByLibrary.simpleMessage("Κουμπιά Επόμενο και Πίσω"),
        "demoSharedXAxisDesignCourseTitle":
            MessageLookupByLibrary.simpleMessage("Σχέδιο"),
        ...
        "demoSharedXAxisIllustrationCourseTitle":
            MessageLookupByLibrary.simpleMessage("Εικονογράφηση"),
        "demoSharedXAxisIndividualCourseSubtitle":
            MessageLookupByLibrary.simpleMessage("Μεμονωμένο"),
        ...
        "demoSharedXAxisSignInWelcomeText":
            MessageLookupByLibrary.simpleMessage("Γεια σας David Park,"),
        "demoSharedXAxisTitle":
            MessageLookupByLibrary.simpleMessage("Κοινόχρηστος άξονας x"),
        "demoSharedYAxisAlbumCount":
            MessageLookupByLibrary.simpleMessage("268 άλμπουμ"),
        "demoSharedYAxisAlbumTileDurationUnit":
            MessageLookupByLibrary.simpleMessage("λ."),
        "demoSharedYAxisAlbumTileSubtitle":
            MessageLookupByLibrary.simpleMessage("Καλλιτέχνης"),
        "demoSharedYAxisAlbumTileTitle":
            MessageLookupByLibrary.simpleMessage("Άλμπουμ"),
        "demoSharedYAxisAlphabeticalSortTitle":
            MessageLookupByLibrary.simpleMessage("Α-Ω"),
        ...
        "demoSharedYAxisRecentSortTitle":
            MessageLookupByLibrary.simpleMessage("Ακούσατε πρόσφατα"),
        "demoSharedYAxisTitle":
            MessageLookupByLibrary.simpleMessage("Κοινόχρηστος άξονας y"),
        "demoSharedZAxisBeefSandwichRecipeDescription":
            MessageLookupByLibrary.simpleMessage(
                "Συνταγή για σάντουιτς με βοδινό"),
        "demoSharedZAxisBeefSandwichRecipeTitle":
            MessageLookupByLibrary.simpleMessage("Σάντουιτς με βοδινό"),
        "demoSharedZAxisBurgerRecipeDescription":
            MessageLookupByLibrary.simpleMessage("Συνταγή μπέργκερ"),
        "demoSharedZAxisBurgerRecipeTitle":
            MessageLookupByLibrary.simpleMessage("Μπέργκερ"),
        "demoSharedZAxisCrabPlateRecipeDescription":
            MessageLookupByLibrary.simpleMessage("Συνταγή για καβούρι"),
        "demoSharedZAxisCrabPlateRecipeTitle":
            MessageLookupByLibrary.simpleMessage("Καβούρι"),
        "demoSharedZAxisDemoInstructions":
            MessageLookupByLibrary.simpleMessage("Κουμπί εικονιδίου ρυθμίσεων"),
        "demoSharedZAxisDessertRecipeDescription":
            MessageLookupByLibrary.simpleMessage("Συνταγή επιδορπίου"),
        "demoSharedZAxisDessertRecipeTitle":
            MessageLookupByLibrary.simpleMessage("Επιδόρπιο"),
        "demoSharedZAxisHelpSettingLabel":
            MessageLookupByLibrary.simpleMessage("Βοήθεια"),
        "demoSharedZAxisNotificationSettingLabel":
            MessageLookupByLibrary.simpleMessage("Ειδοποιήσεις"),
        "demoSharedZAxisPrivacySettingLabel":
            MessageLookupByLibrary.simpleMessage("Απόρρητο"),
        "demoSharedZAxisProfileSettingLabel":
            MessageLookupByLibrary.simpleMessage("Προφίλ"),
        "demoSharedZAxisSandwichRecipeDescription":
            MessageLookupByLibrary.simpleMessage("Συνταγή σάντουιτς"),
        "demoSharedZAxisSandwichRecipeTitle":
            MessageLookupByLibrary.simpleMessage("Σάντουιτς"),
        "demoSharedZAxisSavedRecipesListTitle":
            MessageLookupByLibrary.simpleMessage("Αποθηκευμένες συνταγές"),
        ...
        "demoSharedZAxisShrimpPlateRecipeDescription":
            MessageLookupByLibrary.simpleMessage("Συνταγή για γαρίδες"),
        "demoSharedZAxisShrimpPlateRecipeTitle":
            MessageLookupByLibrary.simpleMessage("Γαρίδες"),
        "demoSharedZAxisTitle":
            MessageLookupByLibrary.simpleMessage("Κοινόχρηστος άξονας z"),
        ...
        "demoTextButtonTitle":
            MessageLookupByLibrary.simpleMessage("Κουμπί κειμένου"),
        ...
        "demoTwoPaneDetails":
            MessageLookupByLibrary.simpleMessage("Λεπτομέρειες"),
        ...
        "demoTwoPaneFoldableLabel":
            MessageLookupByLibrary.simpleMessage("Αναδιπλούμενη"),
        "demoTwoPaneItem": m19,
        "demoTwoPaneItemDetails": m20,
        "demoTwoPaneList": MessageLookupByLibrary.simpleMessage("Λίστα"),
        ...
        "demoTwoPaneSmallScreenLabel":
            MessageLookupByLibrary.simpleMessage("Μικρή οθόνη"),
        ...
        "demoTwoPaneTabletLabel":
            MessageLookupByLibrary.simpleMessage("Tablet/Υπολογιστής"),
        ...
        "demoVerticalDividerTitle":
            MessageLookupByLibrary.simpleMessage("Κάθετο διαχωριστικό"),
        "deselect": MessageLookupByLibrary.simpleMessage("Αποεπιλογή"),
        "dialogAddAccount":
        ...
        "notSelected":
            MessageLookupByLibrary.simpleMessage("Δεν έχει επιλεχθεί"),
        ...
        "replyDraftsLabel": MessageLookupByLibrary.simpleMessage("Πρόχειρα"),
        "replyInboxLabel": MessageLookupByLibrary.simpleMessage("Εισερχόμενα"),
        "replySentLabel": MessageLookupByLibrary.simpleMessage("Απεσταλμένα"),
        "replySpamLabel":
            MessageLookupByLibrary.simpleMessage("Ανεπιθύμητο περιεχόμενο"),
        "replyStarredLabel": MessageLookupByLibrary.simpleMessage("Με αστέρι"),
        "replyTrashLabel": MessageLookupByLibrary.simpleMessage("Κάδος"),
        ...
        "splashSelectDemo":
            MessageLookupByLibrary.simpleMessage("Επιλογή επίδειξης"),

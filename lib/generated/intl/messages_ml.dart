...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(repoLink) =>
      "ഈ ആപ്പിനുള്ള സോഴ്‌സ് കോഡ് കാണാൻ ${repoLink} സന്ദർശിക്കുക.";

  static String m1(title) => "${title} ടാബിനുള്ള പ്ലെയ്സ്‌ഹോൾഡർ";

  static String m2(destinationName) => "${destinationName} അടുത്തറിയുക";

  static String m3(destinationName) => "${destinationName} പങ്കിടുക";
  ...
  static String m10(value) => "${value} തേൻ ചേർത്തത്";

  static String m11(value) => "${value} പഞ്ചസാര ചേർത്തത്";

  static String m12(value) => "ഇനം ${value}";

  static String m13(error) => "ക്ലിപ്പ്ബോർഡിലേക്ക് പകർത്താനായില്ല: ${error}";

  static String m14(value) => "തുടർച്ചയായത്: ${value}";

  static String m15(value) => "ഇടവിട്ടുള്ളത്: ${value}";

  static String m16(value) => "ചെക്ക് ചെയ്തു: ${value}";

  static String m17(value) => "തിരഞ്ഞെടുത്തു: ${value}";

  static String m18(name, phoneNumber) =>
      "${name} എന്ന വ്യക്തിയുടെ ഫോൺ നമ്പർ ${phoneNumber} ആണ്";

  static String m19(value) => "ഇനം ${value}";

  static String m20(value) => "ഇനത്തിന്റെ ${value} വിശദാംശങ്ങൾ";

  static String m21(value) => "നിങ്ങൾ തിരഞ്ഞെടുത്തത്: \"${value}\"";

  static String m22(repoName) => "${repoName} GitHub കലവറ";
  ...
  static String m24(amount) => "നിങ്ങൾ ഈ മാസം ${amount} ATM ഫീസ് അടച്ചു";
  ...
  static String m26(percent) =>
      "ശ്രദ്ധിക്കുക, നിങ്ങൾ ഈ മാസത്തെ ഷോപ്പിംഗ് ബജറ്റിന്റെ ${percent} ചെലവഴിച്ചു.";

  static String m27(amount) =>
      "നിങ്ങൾ ഈ ആഴ്‌ച ${amount} റെസ്റ്റോറന്റുകളിൽ ചെലവഴിച്ചു.";
  ...
  static String m33(quantity) => "അളവ്: ${quantity}";
  ...
  static String m35(product) => "${product} നീക്കുക";

  static String m36(value) => "ഇനം ${value}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "demo": MessageLookupByLibrary.simpleMessage("ഡെമോ"),
        ...
        "demoAppBarTitle": MessageLookupByLibrary.simpleMessage("ആപ്പ് ബാർ"),
        ...
        "demoContainerTransformDemoInstructions":
            MessageLookupByLibrary.simpleMessage("കാർഡുകൾ, ലിസ്‌റ്റുകൾ, FAB"),
        ...
        "demoContainerTransformModalBottomSheetTitle":
            MessageLookupByLibrary.simpleMessage("ഫേഡ് മോഡ്"),
        "demoContainerTransformTitle":
            MessageLookupByLibrary.simpleMessage("കണ്ടെയ്‌നർ ട്രാൻസ്ഫോം"),
        "demoContainerTransformTypeFade":
            MessageLookupByLibrary.simpleMessage("ഫേഡ്"),
        "demoContainerTransformTypeFadeThrough":
            MessageLookupByLibrary.simpleMessage("ഫേഡ് ത്രൂ"),
        ...
        "demoCupertinoContextMenuActionOne":
            MessageLookupByLibrary.simpleMessage("ഒന്നാമത്തെ പ്രവർത്തനം"),
        ...
        "demoCupertinoContextMenuActionTwo":
            MessageLookupByLibrary.simpleMessage("രണ്ടാമത്തെ പ്രവർത്തനം"),
        ...
        "demoCupertinoContextMenuSubtitle":
            MessageLookupByLibrary.simpleMessage("iOS-സ്റ്റൈൽ സന്ദർഭ മെനു"),
        ...
        "demoCupertinoPicker": MessageLookupByLibrary.simpleMessage("പിക്കർ"),
        ...
        "demoCupertinoPickerSubtitle":
            MessageLookupByLibrary.simpleMessage("iOS-സ്റ്റൈൽ പിക്കറുകൾ"),
        ...
        "demoCupertinoScrollbarSubtitle":
            MessageLookupByLibrary.simpleMessage("iOS-സ്റ്റൈൽ സ്ക്രോൾ ബാർ"),
        "demoCupertinoScrollbarTitle":
            MessageLookupByLibrary.simpleMessage("സ്‌ക്രോൾ ബാർ"),
        ...
        "demoCupertinoSearchTextFieldPlaceholder":
            MessageLookupByLibrary.simpleMessage("കുറച്ച് ടെക്സ്റ്റ് നൽകുക"),
        "demoCupertinoSearchTextFieldSubtitle":
            MessageLookupByLibrary.simpleMessage(
                "iOS-സ്റ്റൈൽ തിരയൽ ടെക്‌സ്റ്റ് ഫീൽഡ്"),
        "demoCupertinoSearchTextFieldTitle":
            MessageLookupByLibrary.simpleMessage("തിരയൽ ടെക്‌സ്റ്റ് ഫീൽഡ്"),
        ...
        "demoDateRangePickerTitle":
            MessageLookupByLibrary.simpleMessage("തീയതി ശ്രേണി പിക്കർ"),
        ...
        "demoDividerTitle": MessageLookupByLibrary.simpleMessage("ഡിവൈഡർ"),
        ...
        "demoElevatedButtonTitle":
            MessageLookupByLibrary.simpleMessage("എലവേറ്റഡ് ബട്ടൺ"),
        "demoFadeScaleAlertDialogCancelButton":
            MessageLookupByLibrary.simpleMessage("റദ്ദാക്കുക"),
        "demoFadeScaleAlertDialogDiscardButton":
            MessageLookupByLibrary.simpleMessage("ഉപേക്ഷിക്കുക"),
        "demoFadeScaleAlertDialogHeader":
            MessageLookupByLibrary.simpleMessage("മുന്നറിയിപ്പ് ഡയലോഗ്"),
        "demoFadeScaleDemoInstructions":
            MessageLookupByLibrary.simpleMessage("മോഡൽ, FAB"),
        ...
        "demoFadeScaleHideFabButton":
            MessageLookupByLibrary.simpleMessage("FAB മറയ്ക്കുക"),
        "demoFadeScaleShowAlertDialogButton":
            MessageLookupByLibrary.simpleMessage("മോഡൽ കാണിക്കുക"),
        "demoFadeScaleShowFabButton":
            MessageLookupByLibrary.simpleMessage("FAB കാണിക്കുക"),
        "demoFadeScaleTitle": MessageLookupByLibrary.simpleMessage("ഫേഡ്"),
        "demoFadeThroughAlbumsDestination":
            MessageLookupByLibrary.simpleMessage("ആൽബങ്ങൾ"),
        ...
        "demoFadeThroughTextPlaceholder":
            MessageLookupByLibrary.simpleMessage("123 ഫോട്ടോകൾ"),
        ...
        "demoMotionDetailsPageTitle":
            MessageLookupByLibrary.simpleMessage("വിശദാംശങ്ങൾ പേജ്"),
        "demoMotionListTileTitle":
            MessageLookupByLibrary.simpleMessage("ലിസ്‌റ്റ് ഇനം"),
        "demoMotionPlaceholderSubtitle":
            MessageLookupByLibrary.simpleMessage("ദ്വിതീയ ടെക്‌സ്‌റ്റ്"),
        "demoMotionPlaceholderTitle":
            MessageLookupByLibrary.simpleMessage("പേര്"),
        "demoMotionSmallPlaceholderSubtitle":
            MessageLookupByLibrary.simpleMessage("ദ്വിതീയം"),
        "demoMotionSubtitle": MessageLookupByLibrary.simpleMessage(
            "മൂൻകൂട്ടി നിശ്ചയിച്ച എല്ലാ ട്രാൻസിഷൻ പാറ്റേണുകളും"),
        "demoMotionTitle": MessageLookupByLibrary.simpleMessage("ചലനാത്മകത"),
        ...
        "demoNavigationDrawerTitle":
            MessageLookupByLibrary.simpleMessage("നാവിഗേഷൻ ഡ്രോയർ"),
        "demoNavigationDrawerToPageOne":
            MessageLookupByLibrary.simpleMessage("ഇനം ഒന്ന്"),
        "demoNavigationDrawerToPageTwo":
            MessageLookupByLibrary.simpleMessage("ഇനം രണ്ട്"),
        ...
        "demoNavigationRailFirst":
            MessageLookupByLibrary.simpleMessage("ആദ്യത്തെ"),
        "demoNavigationRailSecond":
            MessageLookupByLibrary.simpleMessage("രണ്ടാമത്തെ"),
        ...
        "demoNavigationRailThird":
            MessageLookupByLibrary.simpleMessage("മൂന്നാമത്തെ"),
        "demoNavigationRailTitle":
            MessageLookupByLibrary.simpleMessage("നാവിഗേഷൻ റെയിൽ"),
        ...
        "demoOutlinedButtonTitle":
            MessageLookupByLibrary.simpleMessage("ഔട്ട്ലൈൻഡ് ബട്ടൺ"),
        ...
        "demoSharedXAxisArtsAndCraftsCourseTitle":
            MessageLookupByLibrary.simpleMessage("കരകൗശല വിദ്യകൾ"),
        "demoSharedXAxisBackButtonText":
            MessageLookupByLibrary.simpleMessage("മടങ്ങുക"),
        "demoSharedXAxisBundledCourseSubtitle":
            MessageLookupByLibrary.simpleMessage("ബണ്ടിൽ ചെയ്‌തു"),
        ...
        "demoSharedXAxisCreateAccountButtonText":
            MessageLookupByLibrary.simpleMessage("അക്കൗണ്ട് സൃഷ്‌ടിക്കുക"),
        "demoSharedXAxisCulinaryCourseTitle":
            MessageLookupByLibrary.simpleMessage("പാചകസംബന്ധമായത്"),
        "demoSharedXAxisDemoInstructions":
            MessageLookupByLibrary.simpleMessage("അടുത്തത്, മടങ്ങുക ബട്ടണുകൾ"),
        "demoSharedXAxisDesignCourseTitle":
            MessageLookupByLibrary.simpleMessage("ഡിസൈൻ"),
        "demoSharedXAxisForgotEmailButtonText":
            MessageLookupByLibrary.simpleMessage("ഇമെയിൽ മറന്നോ?"),
        "demoSharedXAxisIllustrationCourseTitle":
            MessageLookupByLibrary.simpleMessage("ചിത്രീകരണം"),
        ...
        "demoSharedXAxisSignInTextFieldLabel":
            MessageLookupByLibrary.simpleMessage("ഇമെയിൽ അല്ലെങ്കിൽ ഫോൺ നമ്പർ"),
        "demoSharedXAxisSignInWelcomeText":
            MessageLookupByLibrary.simpleMessage("ഹായ് David Park"),
        "demoSharedXAxisTitle":
            MessageLookupByLibrary.simpleMessage("പങ്കിട്ട x-അക്ഷം"),
        "demoSharedYAxisAlbumCount":
            MessageLookupByLibrary.simpleMessage("268 ആൽബങ്ങൾ"),
        "demoSharedYAxisAlbumTileDurationUnit":
            MessageLookupByLibrary.simpleMessage("മിനിറ്റ്"),
        "demoSharedYAxisAlbumTileSubtitle":
            MessageLookupByLibrary.simpleMessage("ആർട്ടിസ്‌റ്റ്"),
        "demoSharedYAxisAlbumTileTitle":
            MessageLookupByLibrary.simpleMessage("ആൽബം"),
        ...
        "demoSharedYAxisRecentSortTitle":
            MessageLookupByLibrary.simpleMessage("അടുത്തിടെ പ്ലേ ചെയ്‌തത്"),
        "demoSharedYAxisTitle":
            MessageLookupByLibrary.simpleMessage("y-അക്ഷം പങ്കിട്ടു"),
        "demoSharedZAxisBeefSandwichRecipeDescription":
            MessageLookupByLibrary.simpleMessage("ബീഫ് സാൻഡ്‌വിച്ച് റെസിപ്പി"),
        "demoSharedZAxisBeefSandwichRecipeTitle":
            MessageLookupByLibrary.simpleMessage("ബീഫ് സാൻഡ്‌വിച്ച്"),
        "demoSharedZAxisBurgerRecipeDescription":
            MessageLookupByLibrary.simpleMessage("ബർഗർ റെസിപ്പി"),
        "demoSharedZAxisBurgerRecipeTitle":
            MessageLookupByLibrary.simpleMessage("ബർഗർ"),
        "demoSharedZAxisCrabPlateRecipeDescription":
            MessageLookupByLibrary.simpleMessage("ഞണ്ട് കറി റെസിപ്പി"),
        "demoSharedZAxisCrabPlateRecipeTitle":
            MessageLookupByLibrary.simpleMessage("ഞണ്ട്"),
        "demoSharedZAxisDemoInstructions":
            MessageLookupByLibrary.simpleMessage("ക്രമീകരണ ഐക്കൺ ബട്ടൺ"),
        "demoSharedZAxisDessertRecipeDescription":
            MessageLookupByLibrary.simpleMessage("ഡെസെർട്ട് റെസിപ്പി"),
        "demoSharedZAxisDessertRecipeTitle":
            MessageLookupByLibrary.simpleMessage("ഡെസെർട്ട്"),
        "demoSharedZAxisHelpSettingLabel":
            MessageLookupByLibrary.simpleMessage("സഹായം"),
        ...
        "demoSharedZAxisSandwichRecipeDescription":
            MessageLookupByLibrary.simpleMessage("സാൻഡ്‌വിച്ച് റെസിപ്പി"),
        "demoSharedZAxisSandwichRecipeTitle":
            MessageLookupByLibrary.simpleMessage("സാൻഡ്‌വിച്ച്"),
        "demoSharedZAxisSavedRecipesListTitle":
            MessageLookupByLibrary.simpleMessage("സംരക്ഷിച്ച റെസിപ്പികൾ"),
        ...
        "demoSharedZAxisShrimpPlateRecipeDescription":
            MessageLookupByLibrary.simpleMessage("ചെമ്മീൻ കറി റെസിപ്പി"),
        "demoSharedZAxisShrimpPlateRecipeTitle":
            MessageLookupByLibrary.simpleMessage("ചെമ്മീൻ"),
        "demoSharedZAxisTitle":
            MessageLookupByLibrary.simpleMessage("z-അക്ഷം പങ്കിട്ടു"),
        ...
        "demoTextButtonTitle":
            MessageLookupByLibrary.simpleMessage("ടെക്‌സ്‌റ്റ് ബട്ടൺ"),
        ...
        "demoTwoPaneDetails":
            MessageLookupByLibrary.simpleMessage("വിശദാംശങ്ങൾ"),
        ...
        "demoTwoPaneFoldableLabel":
            MessageLookupByLibrary.simpleMessage("ഫോൾഡ് ചെയ്യാവുന്നത്"),
        "demoTwoPaneItem": m19,
        "demoTwoPaneItemDetails": m20,
        "demoTwoPaneList": MessageLookupByLibrary.simpleMessage("ലിസ്റ്റ്"),
        "demoTwoPaneSelectItem":
            MessageLookupByLibrary.simpleMessage("ഒരു ഇനം തിരഞ്ഞെടുക്കുക"),
        ...
        "demoTwoPaneSmallScreenLabel":
            MessageLookupByLibrary.simpleMessage("ചെറിയ സ്ക്രീൻ"),
        ...
        "demoTwoPaneTabletLabel":
            MessageLookupByLibrary.simpleMessage("ടാബ്‌ലെറ്റ് / ഡെസ്‌ക്ടോപ്പ്"),
        ...
        "demoVerticalDividerTitle":
            MessageLookupByLibrary.simpleMessage("വെർട്ടിക്കൽ ഡിവൈഡർ"),
        "deselect":
            MessageLookupByLibrary.simpleMessage("തിരഞ്ഞെടുത്തത് മാറ്റുക"),
        "dialogAddAccount":
        ...
        "notSelected": MessageLookupByLibrary.simpleMessage("തിരഞ്ഞെടുത്തില്ല"),
        ...
        "rallySettingsPersonalInformation":
            MessageLookupByLibrary.simpleMessage("വ്യക്തിപരമായ വിവരങ്ങൾ"),
        ...
        "replyDescription": MessageLookupByLibrary.simpleMessage(
            "കാര്യക്ഷമവും എക്‌സ്ക്ലൂസീവുമായ ഇമെയിൽ ആപ്പ്"),
        "replyDraftsLabel":
            MessageLookupByLibrary.simpleMessage("ഡ്രാഫ്റ്റുകൾ"),
        "replyInboxLabel": MessageLookupByLibrary.simpleMessage("ഇൻബോക്‌സ്"),
        "replySentLabel": MessageLookupByLibrary.simpleMessage("അയച്ചു"),
        "replySpamLabel": MessageLookupByLibrary.simpleMessage("സ്‌പാം"),
        "replyStarredLabel":
            MessageLookupByLibrary.simpleMessage("നക്ഷത്രചിഹ്നമിട്ടവ"),
        "replyTrashLabel": MessageLookupByLibrary.simpleMessage("ട്രാഷ്"),
        ...
        "selected": MessageLookupByLibrary.simpleMessage("തിരഞ്ഞെടുത്തു"),
        "settingsAbout":
        ...
        "splashSelectDemo":
            MessageLookupByLibrary.simpleMessage("ഒരു ഡെമോ തിരഞ്ഞെടുക്കുക"),
